		...
		<div class="card-body">
		  ...
		  <div class="form-group">
			...
			<div class="input-group">
			  ...
			  <input type="text" id="title_funfact" name="title_funfact" value="{{ $home_default->title_funfact ?? old('title_funfact') }}" class="form-control" placeholder="Tiêu Đề">
			</div>
		  </div>
		  ...
		  <div class="form-group mt-3">
			...
			<textarea id="content_funfact" name="content_funfact" class="form-control ckeditor-lfm" rows="4">{!! $home_default->content_funfact ?? old('content_funfact') !!}</textarea>
		  </div>
