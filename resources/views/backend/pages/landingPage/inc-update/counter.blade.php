		...
		<div class="card-body">
		  ...
		  <div class="form-group">
			...
			<div class="input-group">
			  ...
			  <input type="text" id="title_funfact" name="title_funfact" value="{{ $landingPage->title_funfact ?? old('title_funfact') }}" class="form-control" placeholder="Tiêu Đề">
			</div>
		  </div>

		  <div id="holder-funfact" class="thumbnail holder-thumbnail text-center">
			@if( !empty( $landingPage->images_funfact ) )
			  <img src="{{ $landingPage->images_funfact }}" style="height: 5rem;">
			@endif
		  </div>
		  <div class="input-group">
			...
			<input id="thumbnail-funfact" class="form-control" type="text" name="images_funfact" value="{{ $landingPage->images_funfact }}">
		  </div>

		  <div class="form-group mt-3">
			<label for="content_funfact">Nội Dung</label>
			<textarea id="content_funfact" name="content_funfact" class="form-control ckeditor-lfm" rows="4">{!! $landingPage->content_funfact ?? old('content_funfact') !!}</textarea>
		  </div>
