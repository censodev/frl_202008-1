		...
		<div class="card-body">
		  ...
		  <div class="form-group">
			...
			<div class="input-group">
			  ...
			  <input type="text" id="title_product_sale" name="title_product_sale" value="{{ $landingPage->title_product_sale ?? old('title_product_sale') }}" class="form-control" placeholder="Tiêu Đề">
			</div>
		  </div>

		  <div id="holder-product-sale" class="thumbnail holder-thumbnail text-center">
			@if( !empty( $landingPage->images_product_sale ) )
			  <img src="{{ $landingPage->images_product_sale }}" style="height: 5rem;">
			@endif
		  </div>
		  <div class="input-group">
			...
			<input id="thumbnail-product-sale" class="form-control" type="text" name="images_product_sale" value="{{ $landingPage->images_product_sale }}">
		  </div>

		  <div class="form-group mt-3">
			<label for="content_product_sale">Nội Dung</label>
			<textarea id="content_product_sale" name="content_product_sale" class="form-control ckeditor-lfm" rows="4">{!! $landingPage->content_product_sale ?? old('content_product_sale') !!}</textarea>
		  </div>
