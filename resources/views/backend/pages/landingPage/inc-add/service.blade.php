			...
			<span class="input-group-btn">
			  <a data-input="thumbnail-service" data-preview="holder-service" class="lfm-mul btn btn-primary">
				<i class="fa fa-picture-o"></i> Ảnh Nền
                    ...
                    <input id="thumbnail-service" class="form-control" type="text" name="images_service" value="">
                </div>
                <div class="form-group mt-3">
                    <label for="content_service">Nội Dung</label>
                    <textarea id="content_service" name="content_service" class="form-control ckeditor-lfm" rows="4"></textarea>
                </div>
