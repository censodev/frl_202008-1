...
@section('content')
    ...
    <section class="content">
      <form role="form" action="{{ route('seeding-fb-comments.update', $seeding->id) }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
        @csrf
        @method('PUT')
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="name" name="name" value="{{ $seeding->name ?? old('name') }}" class="form-control" required placeholder="Nhập tên seeding" oninvalid="this.setCustomValidity('Vui lòng nhập tên seeding.')" oninput="setCustomValidity('')">
                  @if( $errors->has('name') )
        ...
        <div class="row">
          <div class="card-body text-center">
            ...
            <a href="{{ route('seeding-fb-comments.index') }}" class="btn btn-secondary">Thoát</a>
          </div>
        </div>
      </form>
      <!-- /.form -->
