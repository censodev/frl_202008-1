...
@section('content')
    ...
    <section class="content">
        <form role="form" action="{{ route('about.update', $data->about->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body row">
                            <div class="form-group col-md-6">
                                <label>Tiêu đề</label>
                                <input type="text" name="title" value="{{ old('title') ?? $data->about->title }}" placeholder="Nhập tiêu đề"
                                    class="form-control" required>
                            </div>
                            <div class="col-md-6">
                                <label for="">Vị trí nội dung</label>
                                <select name="position" class="form-control">
                                    <option value="0" {{ $data->about->position == 0 ? 'selected' : '' }}>Nội dung bên trái</option>
                                    <option value="1" {{ $data->about->position == 1 ? 'selected' : '' }}>Nội dung bên phải</option>
                                </select>
                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" type="text" name="image" value="{{ old('image') ?? $data->about->image }}">
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="video_embed" class="form-control" rows="4">
                                            {{ old('video_embed') ?? $data->about->video_embed }}
                                        </textarea>
                                    </div>
                                </div>
                            </div>
